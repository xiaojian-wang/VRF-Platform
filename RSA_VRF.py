...
class RSA_FDH_VRF(object):
    ...
    def proof2hash(pi, hash_type="SHA256"):
        '''
...
def get_VRFPK_from_bytes(pk_bytes):
    # define key_pairs dictionary
    key_numbers = {}
    load_public_key_bytes = pk_bytes
...
def VRF_keygen():
    ...
    return rsa_privatekey, rsa_publickey, k
...
if __name__ == "__main__":
    ...
    # print("the private key is: ", rsa_privatekey)
    # print("the public key is: ", rsa_publickey)
    print("the input alpha is: ", alpha)
    print("the proof pi is: ", pi)
    print("the output beta is: ", beta)
    print("final match result is: ", RSA_FDH_VRF.verifying(rsa_publickey, alpha, pi, k))


    # print(beta) # the output is beta, which is the hash of the proof pi
